...
public class GSBowInternal extends Skill {
    public static Builder<GSBowInternal> GetBuilder(String registryName){
        return new Builder<GSBowInternal>().setRegistryName(new ResourceLocation(EpicAddon.MODID, registryName)).setCategory(SkillCategories.WEAPON_PASSIVE);
    }
    ...
    public void onInitiate(SkillContainer container) {
        ...
        container.getExecuter().getSkillCapability().skillContainers[SkillSlots.AIR_ATTACK.universalOrdinal()].setSkill(RegEpicAddonSkills.GS_Bow_FallAttackPatch);
        container.getExecuter().getSkillCapability().skillContainers[SkillSlots.BASIC_ATTACK.universalOrdinal()].setSkill(RegEpicAddonSkills.GS_Bow_BasicAttackPatch);
    }
